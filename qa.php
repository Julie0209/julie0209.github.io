...
<div id="bor" style="width: 10%;"> <br> </div>

    <div id="pic1"><img src="websitetry/objectpicture/圖片29.png"></div>
    <div id="text1"> 什麼是保健食品？ </div>
...
<div id="bor" style="width: 10%;"> <br> </div>
    ...
    <div id="pic2"><img src="websitetry/objectpicture/圖片30.png"></div>
    <div id="text2">舉凡具特定成分,能調節生理機能,可發揮保健功效之食品。</div>
...
<div id="bor" style="width: 10%;"> <br> </div>
    ...
    <div id="pic2"><img src="websitetry/objectpicture/圖片30.png"></div>
    <div id="text2">目前衛福部的規定是維生素含量可以是建議量的1.5倍，若加上日常飲食，其實已經足夠。</div>
...
<div id="bor" style="width: 10%;"> <br> </div>
    ...
    <div id="pic2"><img src="websitetry/objectpicture/圖片30.png"></div>
    <div id="text2"><a href="websitetry/cross.pdf" target="_blank">點此查看</a></div>
