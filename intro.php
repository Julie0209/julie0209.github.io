...
<div style="float: left;width:10%"> <br> </div>
		<div id="pic1"><img src="websitetry/objectpicture/圖片18.png" id="pic2"></div>
<div style="float: left;width:30%"> <br> </div>
			<div style="clear:both"></div>


		
		<div id="pic3" style="float:left;top:-500px; left:125.9px"><a href="intro1.php" title="健康食品標章"><img src="websitetry/objectpicture/圖片19.png" id="pic"></a></div>
		<div id="pic3" style="float:left;top:-490px; left:225px"><a href="intro2.php" title="SGS標章"><img src="websitetry/objectpicture/圖片20.png" id="pic"></a></div>
		<div id="pic3" style="float:left;top:-750px; left:335px"><a href="intro3.php" title="國家品質標章"><img src="websitetry/objectpicture/圖片21.png" id="pic"></a></div>
			<div style="clear:both"></div>
		<br><br>
		<div id="pic3" style="float:left;top:-650px; left:230px"><a href="intro4.php" title="食品GMP標章"><img src="websitetry/objectpicture/圖片22.png" id="pic"></a></div>
		<div id="pic3" style="float:left;top:-670px; left:680px"><a href="intro5.php" title="CNS標章"><img src="websitetry/objectpicture/圖片23.png" id="pic"></a></div>
