...
<div style="float: left; width: 10%;"> <br> </div>
			...
			<div id="pic1" ><img src="websitetry/種類與介紹圖檔/方格1.gif" id="pic2"></div>

			<div id="pic1"><img src="websitetry/種類與介紹圖檔/方格2.gif" id="pic2"></div>
...
<div style="float: left; width: 10%;"> <br> </div>
			...
			<div id="text">
				<a href="vitE.php">維生素E</a>
			</div>

				
			<div id="text">
				<a href="clam.php">蜆精</a>
			</div>
<div style="float: left; width: 10%;"> <br> </div>
<div style="clear: both;"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			...
			<div id="pic1"><img src="websitetry/種類與介紹圖檔/方格3.gif" id="pic2"></div>

			<div id="pic1"><img src="websitetry/種類與介紹圖檔/方格4.gif" id="pic2"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			<div id="text">
				<a href="vitA.php">維生素A</a>
			</div>

			
			<div id="text">
				<a href="ren.php">人參液</a>
			</div>
<div style="float: left; width: 10%; "> <br> </div>
<div style="clear: both;"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			...
			<div id="pic1"><img src="websitetry/種類與介紹圖檔/方格5.png" id="pic2"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			<div id="text">
				<a href="Probiotics.php">乳酸菌</a>
			</div>

			
			<div id="text">
				<a href="gano.php">靈芝</a>
			</div>
<div style="float: left; width: 10%; "> <br> </div>
<div style="clear: both;"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			<div id="text">
				<a href="Glucosamin.php">葡萄糖胺</a>
			</div>


			<div id="text">
				<a href="coll.php">膠原蛋白</a>
			</div>
<div style="float: left; width: 10%; "> <br> </div>
<div style="clear: both;"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			<div id="text">
				<a href="SyntheticVit.php">綜合維他命</a>
			</div>

	
			<div id="text">
				<a href="bee.php">蜂王乳</a>
			</div>
<div style="float: left; width: 10%;"> <br> </div>
<div style="clear: both;"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			<div id="text">
				<a href="Fishoil.php">魚油</a>
			</div>


			<div id="text">
				<a href="aloe.php">蘆薈</a>
			</div>
<div style="float: left; width: 10%; "> <br> </div>
<div style="clear: both;"></div>
...
<div style="float: left; width: 10%; "> <br> </div>
			<div id="text">
				<a href="Chickenessence.php">雞精</a>
			</div>


			<div id="text">
				<a href="speci.php">特殊營養品</a>
			</div>
<div style="float: left; width: 10%; "> <br> </div>
<div style="clear: both;"></div>
